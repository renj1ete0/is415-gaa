...
tmap_mode("plot") +
  ...
  tm_dots("RAIL_TYPE", palette = "darkgreen", title = "Existing MRT") +
  tm_shape(geo_lrt) +
  tm_dots("RAIL_TYPE", palette = "blue", title = "Existing LRT") +
  tm_shape(geo_mrt_future) +
  tm_dots("RAIL_TYPE", palette = "red", title = "Future MRT") +
  tm_layout(legend.position = c("right", "bottom"), 
            title= 'MRT/LRT Stations in Singapore', 
            title.position = c('right', 'top'))
```
...
4.  Plot a tmap and check if points are plotted in the correct regions
    ...
    tm_shape(mpsz) +
      tm_polygons("REGION_N",
                  alpha = 0.5) +
    tm_shape(hdb_resale_sf) +
      tm_dots("town", size = 0.5)
    ```

    [View Interactive Version of Map here](thex03_hdbplot1.html)! *\[20+mb\]*
    ...
    [View Interactive Version of Map here](thex03_hdbplot2.html)! *\[20+mb\]*
